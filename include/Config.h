...
struct UserConfig
{
    ...
    boolean remoteDisplay_SolarMonitor = false;   // solar monitor display to get data from mqtt
    boolean remoteDisplay_BatteryMonitor = false; // battery monitor display to get data from mqtt
