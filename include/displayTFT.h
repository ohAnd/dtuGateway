...
struct DisplayDataTFT
{
    ...
    float battery_StoredEnergy = 0; // battery stored energy (kWh)
...
public:
    ...
    void setRemoteDisplayMode(bool remoteDisplayActive, bool remoteDisplay_SolarMonitor, bool remoteDisplay_BatteryMonitor = false);

private:
    void drawScreen(String version, String time);
    void drawScreen_monitorSolar(String version, String time);
    void drawScreen_monitorBattery(String version, String time);
    void drawScreen_monitorSolarBattery(String version, String time);
    ...
    void drawGauge_SolarMonitor(String time);
    void drawGauge_BatteryMonitor(String time);
    void drawGauge_SolarBatteryMonitor(String time);
    void drawText_Value_Small(uint8_t x = 0, uint8_t y = 0, float value = 0, uint8_t decimals = 1, String unit = "kWh", uint8_t colorRed = 33, uint8_t colorGreen = 150, uint8_t colorBlue = 243);
    void drawText_Value_Large(uint16_t x = 0, uint16_t y = 0, uint16_t value = 0, String unit = "W");
    void drawClockWithBlinkingColon(String time);
    void drawSecondsRing(String time);
    void drawGaugeRing(int32_t value, int32_t maxValue, uint32_t color, uint32_t darkColor, uint32_t edgeColor, int32_t minAngle, int32_t maxAngle);
...
const uint16_t warningWidth = 26;
const uint16_t warningHeight = 26;
const unsigned short warning[0x400] PROGMEM = {
    0x0000,
    0x0000,
    0x0000,
    0x0000,
...
const uint16_t power_offWidth = 100;
const uint16_t power_offHeight = 100;
const unsigned short power_off[0x2710] PROGMEM = {
    0x0000,
    0x0000,
    0x0000,
    0x0000,
